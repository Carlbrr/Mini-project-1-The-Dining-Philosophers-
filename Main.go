	...
	for {
		...
		case msg1 := <-phil0.outgoing:
			if msg1 == -1 {
				...
				fmt.Println("1 - Philosopher 1 is eating " + strconv.Itoa(msg1))
			}
		case msg2 := <-phil1.outgoing:
			if msg2 == -1 {
				fmt.Println("2 - Philosopher 2 is thinking")
			} else {
				fmt.Println("2 - Philosopher 2 is eating " + strconv.Itoa(msg2))
			}
		...
		case msg3 := <-phil2.outgoing:
			if msg3 == -1 {
				...
				fmt.Println("3 - Philosopher 3 is eating " + strconv.Itoa(msg3))
			}
		...
		case msg4 := <-phil3.outgoing:
			if msg4 == -1 {
				...
				fmt.Println("4 - Philosopher 4 is eating " + strconv.Itoa(msg4))
			}
		...
		case msg5 := <-phil4.outgoing:
			if msg5 == -1 {
				...
				fmt.Println("5 - Philosopher 5 is eating " + strconv.Itoa(msg5))
			}
